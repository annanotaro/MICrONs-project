...
fig.tight_layout()
fig.savefig(RESULTS_DIR / f"confusion_q1c_CLEAN_{CHOSEN_SESSION}.png", dpi=150, bbox_inches="tight")
fig.savefig(RESULTS_DIR / f"confusion_q1c_CLEAN_{CHOSEN_SESSION}.pdf", bbox_inches="tight")
plt.close()
...
pd.DataFrame(rows).to_csv(RESULTS_DIR / f"results_step5_confusion_CLEAN_{CHOSEN_SESSION}.csv", index=False)
print(f"Saved confusion_q1c_CLEAN_{CHOSEN_SESSION}.png/.pdf and results CSV")