...
# ======================================================================
data = np.load(RESULTS_DIR / f"features_clean_{CHOSEN_SESSION}.npz", allow_pickle=True)
...
lc_df.to_csv(RESULTS_DIR / f"results_step4_learning_curves_CLEAN_{CHOSEN_SESSION}.csv", index=False)
...
fig.tight_layout()
fig.savefig(RESULTS_DIR / f"learning_curves_CLEAN_{CHOSEN_SESSION}.png", dpi=150, bbox_inches="tight")
fig.savefig(RESULTS_DIR / f"learning_curves_CLEAN_{CHOSEN_SESSION}.pdf", bbox_inches="tight")
plt.close()
...
paired_df.to_csv(RESULTS_DIR / f"results_step4_paired_comparisons_CLEAN_{CHOSEN_SESSION}.csv", index=False)
...
null_df.to_csv(RESULTS_DIR /f"results_step4_permutation_nulls_CLEAN_{CHOSEN_SESSION}.csv", index=False)
...
print("="*70)
print(f"  learning_curves_CLEAN_{CHOSEN_SESSION}.png / .pdf")
print(f"  results_step4_learning_curves_CLEAN_{CHOSEN_SESSION}.csv")
print(f"  results_step4_paired_comparisons_CLEAN_{CHOSEN_SESSION}.csv")
print(f"  results_step4_permutation_nulls_CLEAN_{CHOSEN_SESSION}.csv")